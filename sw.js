// NEXUS v5.8 — Service Worker
// Stale-while-revalidate + cache busting
// Cache name bumped every version to force fresh assets on deploy

const CACHE_NAME = 'nexus-v58-static';
const ASSETS = [
  '/czn-ops-theory/',
